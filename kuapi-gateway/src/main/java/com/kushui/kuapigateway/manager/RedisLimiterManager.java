package com.kushui.kuapigateway.manager;



import com.kushui.kuapicommon.exception.BusinessException;
import com.kushui.kuapicommon.exception.ErrorCode;
...
public class RedisLimiterManager {
    ...
    public void doRateLimit(String key) {
        ...
        // 每当一个操作来了后，请求一个令牌,如上一个用户一秒里有3个令牌，没有令牌了就返回异常
